...
import { Layers, Smartphone, Database, Activity, Search, ExternalLink } from "lucide-react";
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="col-span-full bg-card border rounded-lg p-4">
          ...
          <div className="flex gap-3 flex-wrap">
            <Link href="/brands"><Button className="gap-2"><Layers className="h-4 w-4"/> Manage Brands</Button></Link>
            <Link href="/combos"><Button variant="secondary" className="gap-2"><Database className="h-4 w-4"/> View All Combos</Button></Link>
            <Link href="/search"><Button variant="outline" className="gap-2"><Search className="h-4 w-4"/> Search Database</Button></Link>
            <a href="https://combofinder.iunlockd.com" target="_blank" rel="noreferrer"><Button variant="outline" className="gap-2"><ExternalLink className="h-4 w-4"/> Back to Site</Button></a>
          </div>
        </div>
      </div>
