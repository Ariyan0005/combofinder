...
// Other product-category modules (e.g. Battery/IC Compatibility) reuse this
// same brands/models/compatibility schema, scoped via categoryId. This page
// must exclude brands that belong to one of those other categories, so they
// show up only in their own dedicated admin page, not here as well.
const OTHER_CATEGORY_SLUGS = CATEGORY_MODULES.map((m) => m.slug);
