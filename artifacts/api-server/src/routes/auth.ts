  ...
  if ((req.session as any).authenticated) {
    ...
    res.json({
      ...
      user: {
        ...
        isStaff: (req.session as any).userRole === "Staff" || (req.session as any).userRole === "Technician" || (req.session as any).userRole === "Both",
