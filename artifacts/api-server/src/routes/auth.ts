...
// Public auth config (e.g. Google Client ID)
...
router.post("/auth/login", loginLimiter, async (req, res) => {
  ...
  try {
    ...
    if (staff?.passwordHash) {
      ...
      (req.session as any).userRole = "Staff";
    ...
    res.json({
      ...
      user: {
        ...
        businessType: businessTypeFromDb,
         isStaff: (req.session as any).userRole === "Staff",
