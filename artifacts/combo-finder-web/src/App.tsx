        ...
        <MainLayout>
          <Switch>
            ...
            <Route path="/inventory" component={Inventory} />
             <Route path="/stock-in"><OwnerOnly><GeneralStoreOnly><StockIn /></GeneralStoreOnly></OwnerOnly></Route>
            ...
            <Route path="/knowledge-base"><MobileRepairOnly><KnowledgeBase /></MobileRepairOnly></Route>
             <Route path="/reports"><OwnerOnly><MobileRepairOnly><Reports /></MobileRepairOnly></OwnerOnly></Route>
            <Route path="/unlock-services"><MobileRepairOnly><UnlockServices /></MobileRepairOnly></Route>
             <Route path="/expenses"><OwnerOnly><Expenses /></OwnerOnly></Route>
            ...
            <Route path="/isp-pinout"><MobileRepairOnly><IspPinout /></MobileRepairOnly></Route>
             <Route path="/manage-categories"><OwnerOnly><ManageCategories /></OwnerOnly></Route>
            <Route path="/manage-suppliers">
              <Redirect to="/customers?tab=suppliers" />
            </Route>
             <Route path="/supplier-ledger/:id"><OwnerOnly><SupplierLedger /></OwnerOnly></Route>
            ...
            <Route path="/privacy" component={Privacy} />
            <Route path="/terms" component={Terms} />
             <Route path="/sales-report"><OwnerOnly><SalesReport /></OwnerOnly></Route>
