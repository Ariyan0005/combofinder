...
const CATEGORIES = [
  {
    label: "LCD / Display",
    value: "LCD / Display",
    iconType: "lcd" as const,
    bg: "from-blue-500 to-blue-600",
    light: "bg-blue-50 text-blue-700",
    desc: "Search compatible display combos",
    navigateHome: true,
    dataKey: "LCD / Display",
  },
  {
    ...
    desc: "Compatible batteries by model",
    navigateHome: false,
    dataKey: "Battery",
  },
  {
    ...
    desc: "Compatible USB charging boards",
    navigateHome: false,
  ...
  },
  {
    ...
    desc: "Compatible integrated circuits",
    navigateHome: false,
    ...
    <div className="bg-white rounded-xl border border-border p-4 hover:shadow-sm transition-all">
      ...
      {expanded && (
        <div className="mt-2 flex flex-wrap gap-1.5">
          {models.map((m, i) => (
            <span key={i} className="text-xs bg-muted text-muted-foreground px-2 py-0.5 rounded-md">{m}</span>
          ))}
        </div>
      )}
    </div>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-muted-foreground mt-0.5 text-sm">
          {selected ? activeCategory?.desc : "Select a category to find compatible parts"}
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            className="flex items-center gap-3 bg-gradient-to-r from-emerald-600 to-teal-700 text-white rounded-2xl p-4 hover:opacity-90 transition-opacity"
          >
            ...
            <div className="flex-1">
              <p className="text-[10px] text-white/70 uppercase tracking-wide font-medium">Buy Parts in Oman 🇴🇲</p>
              <p className="text-sm font-bold leading-tight">GadgetSalalah.com</p>
              <p className="text-xs text-white/60 mt-0.5">LCD · Battery · Accessories · Salalah</p>
            </div>
