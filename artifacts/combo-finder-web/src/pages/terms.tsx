    ...
    <div className="min-h-screen px-5 py-10 max-w-2xl mx-auto"
      ...
      <div className="space-y-7 text-sm leading-relaxed" style={{ color: "hsl(var(--muted-foreground))" }}>
        ...
        <section>
          ...
          <p>
            By creating an account or using PosCert, you agree to these Terms of Service.
        ...
        <section>
          ...
          <p>
            PosCert is a business management tool for mobile phone repair technicians. It provides
        ...
        <section>
          ...
          <p className="mb-2">
            When you connect Google Drive, you grant PosCert permission to create and manage
        ...
        <section>
          ...
          <p>
            PosCert is provided "as is" without warranties of any kind. We are not liable
