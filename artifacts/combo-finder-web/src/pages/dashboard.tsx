...
export default function Dashboard() {
  ...
  const useLocalSummary = isFreePlan && !user?.isStaff;
  ...
  const KPI_CARDS = user?.isStaff ? [
    { label: "Revenue", value: 0, color: "#10B981", bg: "#ECFDF5", prefix: sym },
    ...
    { label: "Outstanding", value: 0, color: "#F59E0B", bg: "#FFFBEB", prefix: sym },
  ] : [
