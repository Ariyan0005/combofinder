      ...
      <div className="flex-1 flex items-start md:items-center justify-center p-5 pt-3">
        <div className="w-full max-w-sm">
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            ...
            <button
              type="button"
              onClick={() => setError("Apple sign-in is not configured yet. Please sign in with Google or Email.")}
              className="flex flex-col items-center justify-center gap-1.5 py-3 rounded-xl border text-xs font-semibold transition-colors opacity-70 hover:opacity-100"
              style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))", color: "hsl(var(--foreground))" }}
            >
              <AppleIcon />
              <span>Apple</span>
            ...
            <button
              type="button"
              onClick={() => setError("GitHub sign-in is not configured yet. Please sign in with Google or Email.")}
              className="flex flex-col items-center justify-center gap-1.5 py-3 rounded-xl border text-xs font-semibold transition-colors opacity-70 hover:opacity-100"
              style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))", color: "hsl(var(--foreground))" }}
            >
              <GitHubIcon />
