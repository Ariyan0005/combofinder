...
export default function Ledger() {
  ...
  const rangeTotals = useMemo(() => {
    ...
    // A debit is a sale/amount the customer owes; a credit is a payment.
    // Keep this aligned with the account-list and API calculations.
  ...
  function handlePrint() {
    ...
    <p style="margin-top:20px;font-size:11px;color:#9ca3af">Generated by PosCert · ${escapeHtml(new Date().toLocaleString())}</p>
    </body></html>`;
