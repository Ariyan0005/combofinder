    ...
    <div className="min-h-screen px-5 py-10 max-w-2xl mx-auto"
      ...
      <div className="mb-8">
        ...
        <p className="text-sm" style={{ color: "hsl(var(--muted-foreground))" }}>
          PosCert · combofinder.iunlockd.com · Last updated: July 2025
        </p>
      </div>
      ...
      <div className="space-y-7 text-sm leading-relaxed" style={{ color: "hsl(var(--muted-foreground))" }}>
        ...
        <section>
          ...
          <p>
            PosCert is a tool for mobile phone repair technicians. We take your privacy seriously.
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>We request the <strong style={{ color: "hsl(var(--foreground))" }}>drive.file</strong> scope only — this gives us access exclusively to files that PosCert itself creates.</li>
            ...
            <li>Your backup file contains only your own PosCert data (inventory, customers, etc.).</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>To provide and improve the PosCert service.</li>
      ...
      <div className="mt-10 pt-6 border-t text-xs text-center"
        ...
        © {new Date().getFullYear()} PosCert · iunlockd.com
      </div>
    </div>
  );
}
