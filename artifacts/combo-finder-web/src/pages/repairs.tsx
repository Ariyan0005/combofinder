      ...
      <div className="relative w-full max-w-md rounded-t-3xl md:rounded-3xl shadow-2xl flex flex-col"
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          <div className="rounded-2xl p-4 space-y-2" style={{ background: BG, border: `1px solid ${BORDER}` }}>
            <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: MUTED }}>📱 Device & Problem</p>
          ...
          {/* Update Status */}
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: MUTED }}>🔧 Update Status</p>
          ...
          {Number(repair.totalCost) > 0 && (
            <div className="rounded-2xl p-4 space-y-2" style={{ background: BG, border: `1px solid ${BORDER}` }}>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: MUTED }}>💰 Billing</p>
              ...
              {Number(repair.advancePaid) > 0 && (
                <div className="flex justify-between text-xs">
                  <span style={{ color: MUTED }}>Advance Paid</span>
                  <span className="font-semibold" style={{ color: "#059669" }}>{Number(repair.advancePaid).toFixed(2)}</span>
                </div>
              )}
              <div className="rounded-xl px-3 py-2"
                style={{ background: repair.isPaid ? "#ECFDF5" : "#FEF2F2", border: `1px solid ${repair.isPaid ? "#6EE7B7" : "#FCA5A5"}` }}>
                <span className="text-xs font-bold" style={{ color: repair.isPaid ? "#059669" : "#DC2626" }}>
          ...
          {partsArr.length > 0 && (
            <div className="rounded-2xl p-4 space-y-2" style={{ background: BG, border: `1px solid ${BORDER}` }}>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-2" style={{ color: MUTED }}>📦 Parts Used</p>
              {partsArr.map((p, i) => (
          ...
          {repair.engineer && (
            <div className="rounded-2xl p-4" style={{ background: BG, border: `1px solid ${BORDER}` }}>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: MUTED }}>🛠 Technician</p>
          ...
          {repair.notes && (
            <div className="rounded-2xl p-4" style={{ background: BG, border: `1px solid ${BORDER}` }}>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-1" style={{ color: MUTED }}>📝 Notes</p>
