...
import { Eye, EyeOff, Search, Check, ChevronDown, Loader2, CheckCircle2, XCircle, X } from "lucide-react";
...
export default function Register() {
  ...
  async function handleGoogleSignUp() {
    ...
    try {
      ...
      setError(err.message || "Google sign-up failed. Please check your Google Client ID.");
    } finally {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="grid grid-cols-3 gap-2 mb-2">
            <button
              ...
              className="flex flex-col items-center justify-center gap-1 py-2 rounded-xl border text-xs font-semibold transition-colors disabled:opacity-50 cursor-pointer"
              style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))", color: "hsl(var(--foreground))" }}
            ...
            <button
              ...
              disabled={socialLoading || loading}
              className="flex flex-col items-center justify-center gap-1 py-2 rounded-xl border text-xs font-semibold transition-colors cursor-pointer hover:opacity-100 disabled:opacity-50"
              style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))", color: "hsl(var(--foreground))" }}
              onMouseEnter={e => { e.currentTarget.style.background = "hsl(var(--muted))"; }}
              onMouseLeave={e => { e.currentTarget.style.background = "hsl(var(--card))"; }}
            >
            ...
            <button
              type="button"
              onClick={() => setError("Apple sign-up is not configured yet. Please sign up with Google or Email.")}
              className="flex flex-col items-center justify-center gap-1 py-2 rounded-xl border text-xs font-semibold transition-colors opacity-70 hover:opacity-100"
              style={{ borderColor: "hsl(var(--border))", background: "hsl(var(--card))", color: "hsl(var(--foreground))" }}
            >
              <AppleIcon />
              <span>Apple</span>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <span className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  ...
                  {emailStatus === "taken" && !emailTypo && (
                    <button
                      type="button"
                      aria-label="Clear unavailable email"
                      onClick={clearEmail}
                      className="rounded-full p-0.5 transition-opacity hover:opacity-70"
                    >
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? "text" : "password"} placeholder="Create a strong password (min 8 chars)"
            ...
            {/* Country — searchable picker; timezone detection still preselects a country */}
            <div>
              <label className="text-sm font-semibold block mb-1">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <button
                    ...
                    className="flex-1 min-h-[68px] flex flex-col items-center justify-center gap-1 px-2.5 py-2 rounded-xl border text-sm font-semibold transition-all"
                    style={{
                      borderColor: form.businessType === opt.value
                        ? opt.value === "general_store" ? "#16a34a" : "hsl(var(--primary))"
                        : "hsl(var(--border))",
                      background: form.businessType === opt.value
                        ? opt.value === "general_store" ? "#f0fdf4" : "hsl(var(--primary) / 0.08)"
                        : "hsl(var(--card))",
                      color: form.businessType === opt.value
                        ? opt.value === "general_store" ? "#15803d" : "hsl(var(--primary))"
                        : "hsl(var(--foreground))",
                    }}
                  >
