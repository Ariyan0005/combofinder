...
import { Smartphone, Globe, ChevronDown, MessageCircle } from "lucide-react";

const WHATSAPP_URL = "https://wa.me/96897043234";

export type Lang = "en" | "bn" | "ar" | "hi";

const LANGUAGES: { code: Lang; flag: string; label: string; dir?: "rtl" }[] = [
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={ref}>
          ...
          {open && (
            <div
              className="absolute right-0 mt-1 w-36 rounded-xl border shadow-lg z-50 overflow-hidden"
              style={{
                borderColor: "hsl(var(--border))",
            ...
            >
              {LANGUAGES.map(l => (
                <button
                  ...
                  onMouseEnter={e => {
                    if (l.code !== lang) e.currentTarget.style.background = "hsl(var(--muted))";
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.background = l.code === lang ? "hsl(var(--primary) / 0.08)" : "transparent";
                  }}
                >
