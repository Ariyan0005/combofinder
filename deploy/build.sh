...
if [ -z "$SUPABASE_DATABASE_URL" ]; then
  ...
  echo ""
  echo "এভাবে run করুন:"
echo "  SUPABASE_DATABASE_URL='<your database URL>' bash deploy/build.sh"
  exit 1
fi
...
cp -r artifacts/combo-finder-web/dist/* /var/www/combofinder/web/
...
echo ""
echo "  1) /var/www/combofinder/.env ফাইলে secrets সেট করুন:"
echo "     SUPABASE_DATABASE_URL, SESSION_SECRET, ADMIN_USERNAME, ADMIN_PASSWORD"
echo "     (এই values কখনও service file বা repo-তে লিখবেন না)"
echo ""
